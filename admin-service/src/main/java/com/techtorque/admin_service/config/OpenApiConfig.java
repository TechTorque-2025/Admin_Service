...
/**
 * OpenAPI/Swagger configuration for Admin & Reporting Service
 * 
 * Access Swagger UI at: http://localhost:8087/swagger-ui/index.html
 * Access API docs JSON at: http://localhost:8087/v3/api-docs
 */
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("TechTorque Admin & Reporting Service API")
                        .version("1.0.0")
                        .description(
                            "REST API for administration and reporting. " +
                            "This service provides admin functions, analytics, and business intelligence reports.\n\n" +
                            "**Key Features:**\n" +
